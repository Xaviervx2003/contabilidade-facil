...
const RingProgress = ({ value, size = 120, stroke = 10, color }) => {
...
const MeuRiscoPlano = () => {
    ...
    let riscoCor = tk.babu
    let riscoBg = `${tk.babu}15`
        ...
        <div className="fade-in pb-5" style={{ background: 'var(--color-bg-primary)', minHeight: '100vh', fontFamily: "'Nunito', sans-serif" }}>
            <CContainer fluid className="px-3 px-md-5" style={{ paddingTop: 32 }}>
                <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                    ...
                    >
                        <div style={{ color: tk.rausch, fontWeight: 800, fontSize: 10, textTransform: 'uppercase', letterSpacing: '1px', marginBottom: 4 }}>Sua Jornada</div>
                    ...
                    {!metrics || metrics.sessoes === 0 ? (
                        ...
                        >
                            ...
                            <p style={{ color: tk.foggy, maxWidth: 500, margin: '0 auto 24px', fontSize: 14, lineHeight: 1.6 }}>
                            ...
                            <CCol lg={7}>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                                    ...
                                    >
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 24, flexWrap: 'wrap' }}>
                                            ...
                                            <div style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
                                                ...
                                                <div style={{
                                                    ...
                                                    <span style={{ fontSize: 9, color: tk.foggy, fontWeight: 700, textTransform: 'uppercase' }}>Risco</span>
                                                </div>
                                            </div>
                                        ...
                                        <hr style={{ borderTop: `1px solid ${tk.border}`, margin: '20px 0' }} />

                                        {/* Sub indicadores */}
                                        <CRow className="g-3 text-center">
                                            <CCol xs={6}>
                                                <div style={{ background: tk.bgSub, borderRadius: 16, padding: '12px 10px' }}>
                                                    <div style={{ color: tk.foggy, fontSize: 11, fontWeight: 700, marginBottom: 4 }}>RETENÇÃO DE 30 DIAS</div>
                                                    <div style={{ fontSize: 18, fontWeight: 900, color: tk.babu }}>
                                            ...
                                            <CCol xs={6}>
                                                <div style={{ background: tk.bgSub, borderRadius: 16, padding: '12px 10px' }}>
                                                    <div style={{ color: tk.foggy, fontSize: 11, fontWeight: 700, marginBottom: 4 }}>SIMULADOS FOCADOS</div>
                                                    <div style={{ fontSize: 18, fontWeight: 900, color: tk.rausch }}>
                                    ...
                                    >
                                        <h4 style={{ fontWeight: 800, fontSize: 16, color: 'var(--color-text-primary)', marginBottom: 6, display: 'flex', alignItems: 'center', gap: 8 }}>
                                            <Icon icon="solar:lightbulb-bold-duotone" style={{ color: tk.gold }} width="20" />
                                            Foco de Estudo Recomendado
                                        </h4>
                                        <p style={{ fontSize: 12, color: tk.foggy, marginBottom: 20 }}>
                                            Matérias onde você teve maior taxa de erro. Sugerimos revisar estes temas.
                                        </p>

                                        {materiasFracas.length === 0 ? (
                                            <div style={{ textAlign: 'center', padding: '20px 0', color: tk.foggy, fontSize: 13 }}>
                                                ...
                                                {materiasFracas.map((item, idx) => (
                                                    ...
                                                    >
                                                        <div style={{ minWidth: 0 }}>
                                                            ...
                                                            <div style={{ fontSize: 11, color: tk.foggy, marginTop: 2 }}>
                            ...
                            <CCol lg={5}>
                                ...
                                >
                                    <h4 style={{ fontWeight: 800, fontSize: 16, color: 'var(--color-text-primary)', marginBottom: 4, display: 'flex', alignItems: 'center', gap: 8 }}>
                                        <Icon icon="solar:calendar-date-bold-duotone" style={{ color: tk.babu }} width="20" />
                                    ...
                                    {/* SLIDER DE HORAS */}
                                    <div style={{ background: tk.bgSub, borderRadius: 18, padding: '16px 20px', marginBottom: 24 }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                                            <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--color-text-secondary)' }}>Meta de Carga Horária</span>
                                            <span style={{ fontSize: 18, fontWeight: 900, color: tk.babu }}>{horasSemanais} horas</span>
                                        </div>
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 10, color: tk.foggy, marginTop: 6 }}>
                                            ...
                                            return (
                                                <motion.div 
                                                    ...
                                                    style={{
                                                        ...
                                                        border: `1px solid ${isChecked ? 'transparent' : tk.border}`,
                                                        borderRadius: 14,
                                                        padding: '12px 14px',
                                                        cursor: 'pointer',
                                                ...
                                                >
                                                    ...
                                                    <div style={{ marginTop: 2, flexShrink: 0 }}>
                                                        <Icon 
                                                            ...
                                                            width="18" 
                                                            style={{ color: isChecked ? tk.babu : tk.foggy }} 
                                                        />
                                                    </div>
                                                    ...
                                                    <div style={{ flex: 1 }}>
                                                        <div style={{ 
                                                            fontSize: 13, 
                                                            fontWeight: 600, 
                                                            color: isChecked ? tk.foggy : 'var(--color-text-primary)',
                                                    ...
                                                    <Icon icon={meta.icon} width="16" style={{ color: isChecked ? tk.babu : tk.foggy, opacity: 0.5, flexShrink: 0 }} />
                                                </motion.div>
                                            )
                                        })}
                                    </div>
                                    ...
                                    {metasAtuais.length > 0 && (
                                        <div style={{ marginTop: 24 }}>
                                            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: tk.foggy, marginBottom: 6 }}>
