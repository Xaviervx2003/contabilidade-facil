...
export const QuizRunning = ({
  ...
  return (
      ...
      <div className="mb-4 pt-1">
        ...
        <div className="d-flex align-items-start gap-3">
          ...
          >
            <CIcon
              icon={cilStar}
              style={{ color: favoritos.includes(currentQuestion.id) ? 'var(--color-warning, #f59e0b)' : '#94a3b8' }}
              width={20}
              height={20}
            />
          </button>
    ...
    <div className="d-flex flex-column gap-2 mb-4">
      ...
      {/* ───────────────────────────────────────────────────────────────── */}
      <div
        className="d-flex flex-column flex-md-row justify-content-md-between align-items-stretch align-items-md-center gap-2 mt-3 bg-body py-3 border-top quiz-sticky-footer"
      >
