    ...
    <CRow className={props.className} xs={{ gutter: 4 }}>
        ...
        <CWidgetStatsA
          ...
          action={
            <CDropdown alignment="end">
              ...
              <CDropdownMenu>
                <CDropdownItem>Ver relatório</CDropdownItem>
              </CDropdownMenu>
            </CDropdown>
          }
          chart={
      ...
      <CCol sm={6} xl={4} xxl={3}>
        <CWidgetStatsA
          ...
          value={
            <>
              {customStats.total_questoes_resolvidas}{' '}
              <span className="fs-6 fw-normal">
                (Base total)
              </span>
            </>
          }
          title="Questões Treinadas"
          action={
            <CDropdown alignment="end">
              <CDropdownToggle color="transparent" caret={false} className="text-white p-0">
                <CIcon icon={cilOptions} />
              ...
              <CDropdownMenu>
                <CDropdownItem>Ver dados</CDropdownItem>
              </CDropdownMenu>
            </CDropdown>
          }
          chart={
      ...
      <CCol sm={6} xl={4} xxl={3}>
        <CWidgetStatsA
          ...
          value={
            <>
              {customStats.tempo_medio_minutos}{' '}
              <span className="fs-6 fw-normal">
                (Minutos)
              </span>
            </>
          }
          title="Tempo Médio Em Prova"
          action={
            <CDropdown alignment="end">
              <CDropdownToggle color="transparent" caret={false} className="text-white p-0">
                <CIcon icon={cilOptions} />
